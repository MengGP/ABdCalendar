    ...
    */
    ...
    public void genRndData(View view) {
        ...
        for (int i=0; i<fullName.length; i++) {
            // event_name
            fullName[i] = firstNames[ (int)((Math.random()*(firstNames.length))-1) ] + " " + lastNames[ (int)((Math.random()*(lastNames.length))-1) ];
            ...
            if (tmpMonth < 10 ) strDate[i] += "0" + tmpMonth;
            else strDate[i] += tmpMonth;
            strDate[i] += "-";
            if (tmpDay < 10 ) strDate[i] += "0" + tmpDay;
            else strDate[i] += tmpDay;

            // event_type
            int eventTypeNum = rndBetween(1,5);
            if (eventTypeNum==1) eventType= EventType.convertToString( EventType.BIRTHDAY );
            else if (eventTypeNum==2) eventType= EventType.convertToString( EventType.ANNIVERSARY );
            else if (eventTypeNum==3) eventType= EventType.convertToString( EventType.MEMODATE );
            else if (eventTypeNum==4) eventType= EventType.convertToString( EventType.HOLIDAY );
            else eventType= EventType.convertToString( EventType.OTHER );
            ...
            else if (eventImg==3) eventImg=R.drawable.ev_img_batman_logo;
            else if (eventImg==4) eventImg=R.drawable.ev_img_batman_logo;
            else if (eventImg==5) eventImg=R.drawable.ev_img_batman_logo;
            else if (eventImg==6) eventImg=R.drawable.ev_img_batman_logo;
            else if (eventImg==7) eventImg=R.drawable.ev_img_batman_logo;
            else if (eventImg==8) eventImg=R.drawable.ev_img_batman_logo;
            else if (eventImg==9) eventImg=R.drawable.ev_img_batman_logo;
            else if (eventImg==10) eventImg=R.drawable.ev_img_batman_logo;
            else if (eventImg==11) eventImg=R.drawable.ev_img_batman_logo;
            else if (eventImg==12) eventImg=R.drawable.ev_img_batman_logo;
            else if (eventImg==13) eventImg=R.drawable.ev_img_batman_logo;
            else if (eventImg==14) eventImg=R.drawable.ev_img_batman_logo;
            else if (eventImg==15) eventImg=R.drawable.ev_img_batman_logo;
        }
